...
/* Standalone single-offer landing page, built to blast to old leads. No nav,
   no other services, no exits. Just the offer, the form, and proof. Form
   submissions are tagged source="detail-offer-lp" so blast leads are trackable
   separately in the ops dashboard. Noindex so it never competes with /detailing. */

export const metadata: Metadata = {
  title: "Exterior Detail + Free Interior | Smiths Detailing Cairns",
  description:
    "Book an exterior detail with a full multi-stage cut & polish and get a full interior detail, engine bay and plastics restored, free. Over $515 in free value. Cairns. If you're not happy, you don't pay.",
  robots: { index: false, follow: false },
  alternates: { canonical: "/detail-offer" },
};

const STACK: { t: string; d: string; free?: boolean }[] = [
  { t: "Full exterior detail", d: "Wash, decontamination and protection, done properly." },
  {
    t: "Upgraded to a multi-stage paint correction",
    d: "You book a cut & polish, we take it further with a full multi-stage correction that removes swirls, scratches and oxidation, not a quick buff.",
  },
...
export default function DetailOfferLanding() {
  return (
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center">
          ...
          <Reveal delay={200}>
            <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-white/65">
              A proper multi-stage paint correction that cuts out the swirls, scratches and oxidation and brings back the
              deep, wet gloss, then a full interior detail on the house.
            </p>
          </Reveal>
        </div>
        ...
        <div className="relative mx-auto mt-11 grid max-w-6xl items-start gap-10 px-4 lg:grid-cols-2">
          ...
          <Reveal delay={150}>
            <div id="claim" className="scroll-mt-6">
              <DetailOfferForm source="detail-offer-lp" />
            </div>
          </Reveal>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-2xl px-4 text-center">
          <Reveal>
            ...
            <p className="mx-auto mt-4 max-w-md text-base leading-relaxed text-white/60">
              Over $515 in free extras, on top of your detail. Drop your details and Thanyon will call you to lock it in.
            </p>
