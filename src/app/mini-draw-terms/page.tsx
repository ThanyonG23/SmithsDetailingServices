...
export const metadata: Metadata = {
  title: "Mini Draw · Terms & Conditions | Smiths Detailing",
  description: "Terms & conditions for the Smiths Detailing weekly mini member draw.",
  robots: { index: false, follow: false },
  alternates: { canonical: "/mini-draw-terms" },
};
...
const TERMS: Term[] = [
  ...
  },
  {
    ...
    body: "Entry is based on your Smiths Detailing membership being active (payments up to date) as at 11:59pm AEST on 20 September 2026, the eligibility cut-off.",
  },
  {
  ...
  },
  {
    ...
    choices: [
      "$300 cash, paid by bank transfer; or",
      "A Premium Detail, valued at $400 or more, carried out at our Cairns workshop.",
    ],
    note: "Total prize value: up to $400. The prize is not transferable and cannot be split part-cash / part-service. If the winner chooses the detail, it must be booked and redeemed at our Cairns workshop within 3 months of the draw, subject to availability, on a vehicle in ordinary condition (excessive damage or rust will be quoted separately).",
  },
  {
    heading: "7. The draw",
    body: "The winner will be drawn at random on 21 September 2026 at our Cairns workshop. The draw may be recorded.",
  },
  {
...
export default function MiniDrawTermsPage() {
  return (
      ...
      <div className="mx-auto max-w-2xl px-5 py-14 sm:py-20">
        ...
        <div className="mt-8 text-center">
          ...
          <h1 className="mt-6 font-display text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            Mini Draw, Terms &amp; Conditions
          </h1>
          <p className="mt-2 text-sm text-white/40">Smiths Detailing Mini Draw · Cairns</p>
        </div>
